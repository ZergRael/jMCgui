...
public enum Packet {
    ...
    SteerVehicle(0x1B, PSteerVehicle.class),
    ...
    NamedSoundEffet(0x3E, PNamedSoundEffect.class),
    Particle(0x3F, PParticle.class),
    GameStateChange(0x46, PGameStateChange.class),
    SpawnGlobalEntity(0x47, PSpawnGlobalEntity.class),
    ...
    TileEditorOpen(0x85, PTileEditorOpen.class),
    ...
    TabComplete(0xCB, PTabComplete.class),
    ClientSettings(0xCC, PClientSettings.class),
    ...
    EncryptionKeyResponse(0xFC, PEncryptionKeyResponse.class),
    ...
    public static Class<MPWPacket> fromCode(int hexCode) {
        Packet[] packets = Packet.values();
        for (Packet packet : packets) {
            if (packet.getHexCode() == hexCode)
